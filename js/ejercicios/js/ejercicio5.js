class Persona {
  ...
  let persona1 = new Persona("Nico", 30, 36420894, "H", 106, 1.80, 1991);
  let persona2 = new Persona("Andres", 62, 14481138, "H", 90, 1.75, 1963);
  let persona3 = new Persona("Jorgelina", 60, 18944111, "M", 70, 1.55, 1965);
  let persona4 = new Persona("Pedro", 50, 22334455, "H", 70, 1.40, 1971);
  let persona5 = new Persona("Jorge", 80, 22334455, "H", 60, 1.70, 1931);
  let persona6 = new Persona("Estefania", 20, 22334455, "M", 48, 1.70, 2002);
